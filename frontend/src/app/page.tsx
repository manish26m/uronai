...
export default function LandingPage() {
  ...
  const features = [
    { icon: Brain, title: "AI-Generated Roadmaps", desc: "Instantly build personalized skill trees tailored to your exact pacing and goals.", color: "from-red-400 to-indigo-500", shadow: "shadow-red-500/50" },
    ...
    { icon: Trophy, title: "Gamified Progression", desc: "Earn XP, unlock certificates, and prove your readiness to top-tier employers.", color: "from-fuchsia-400 to-amber-500", shadow: "shadow-amber-500/50" },
  ];

  if (!mounted) return <div className="min-h-screen bg-[#0c0505]" />;

  return (
    <div className="min-h-screen bg-[#0c0505] text-white font-sans selection:bg-red-500/30 overflow-x-hidden relative">
      ...
      <div className="absolute bottom-[-10%] left-[20%] w-[60vw] h-[60vw] bg-red-600/15 rounded-full blur-[150px] pointer-events-none mix-blend-screen" />

      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 sm:px-12 py-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-red-500 to-amber-600 rounded-2xl blur-md opacity-50 group-hover:opacity-100 transition-opacity duration-500"></div>
          ...
          <span className="text-2xl font-black tracking-tight text-white drop-shadow-md">uron<span className="bg-gradient-to-r from-red-400 to-indigo-400 bg-clip-text text-transparent">ai</span></span>
        </div>
        <div className="flex items-center gap-4">
          ...
          <Link href="/auth/register" className="relative group overflow-hidden rounded-2xl p-[1px]">
            <span className="absolute inset-0 bg-gradient-to-r from-red-500 via-amber-500 to-indigo-500 rounded-2xl opacity-70 group-hover:opacity-100 transition-opacity duration-300"></span>
            <div className="relative bg-black/40 backdrop-blur-xl hover:bg-black/20 text-white text-sm font-bold px-6 py-3 rounded-2xl transition-all flex items-center gap-2">
              <Sparkles size={16} className="text-red-300" /> Start Free
            </div>
          </Link>
        </div>
      </nav>
      ...
      <section className="relative pt-44 pb-32 px-6 lg:px-12 max-w-7xl mx-auto flex flex-col items-center text-center z-10">
        <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 backdrop-blur-md px-5 py-2.5 rounded-full mb-8 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.5)]">
          <div className="w-2 h-2 rounded-full bg-red-400 animate-pulse shadow-[0_0_8px_rgba(59,130,246,0.8)]"></div>
          <span className="text-xs font-bold tracking-widest uppercase text-red-200">The Future of Learning is Here</span>
        </div>
        
        <h1 className="text-6xl sm:text-7xl lg:text-[6rem] font-black tracking-tighter leading-[1.05] mb-8 drop-shadow-2xl">
          Learn anything.<br />
          <span className="relative inline-block pb-2">
            <span className="bg-gradient-to-r from-red-400 via-indigo-300 to-amber-400 bg-clip-text text-transparent">Master everything.</span>
            <div className="absolute bottom-0 left-0 right-0 h-3 bg-gradient-to-r from-red-500/40 to-amber-500/40 blur-lg rounded-full"></div>
          </span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-5 w-full sm:w-auto">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-red-600 to-amber-600 rounded-2xl blur-xl opacity-50 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="relative bg-gradient-to-r from-red-500 to-amber-500 border border-white/20 text-white font-black text-lg px-10 py-5 rounded-2xl flex items-center justify-center gap-3 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)] transform transition-transform duration-300 group-hover:scale-105">
      ...
      <section className="relative px-6 py-32 z-10">
        <div className="max-w-5xl mx-auto relative group">
          <div className="absolute inset-0 bg-gradient-to-r from-red-600 via-indigo-600 to-amber-600 rounded-[3rem] blur-2xl opacity-30 group-hover:opacity-50 transition-opacity duration-700"></div>
          <div className="relative bg-[#0d1126]/90 backdrop-blur-3xl border border-white/10 rounded-[3rem] p-12 sm:p-20 text-center overflow-hidden shadow-[inset_0_2px_4px_rgba(255,255,255,0.1)]">
            ...
            <Zap size={40} className="mx-auto text-red-400 mb-6 drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]" />
      ...
      <footer className="relative border-t border-white/5 px-6 py-12 text-center z-10 bg-black/40 backdrop-blur-md">
        <div className="flex items-center justify-center gap-2 mb-4 opacity-50">
          <div className="w-6 h-6 bg-gradient-to-br from-red-500 to-amber-600 rounded-lg flex items-center justify-center text-white font-black text-xs">U</div>
          <span className="font-black tracking-tight text-white">uron<span className="text-red-400">ai</span></span>
        </div>
