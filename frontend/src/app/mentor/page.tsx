    ...
    <div className="flex flex-col h-[calc(100vh-120px)] max-w-6xl mx-auto w-full gap-6">
      <div className="flex flex-col md:flex-row gap-6 h-full overflow-hidden">
        ...
        <div className="w-full md:w-72 flex flex-col gap-4">
          ...
          <div className="hidden md:flex flex-col gap-3 bg-gradient-to-br from-indigo-900/20 to-purple-900/10 border border-indigo-500/20 rounded-2xl p-5">
          ...
          >
            ...
            {loading && (
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 text-white flex items-center justify-center flex-shrink-0">
                  <Bot size={20} />
                </div>
          ...
          <div className="p-4 bg-gray-950/80 border-t border-gray-800 backdrop-blur-md">
            <form onSubmit={handleSend} className="relative max-w-4xl mx-auto w-full">
              <input 
                ...
                className="w-full bg-gray-900 border border-gray-700 focus:border-blue-500 rounded-2xl pl-6 pr-14 py-4 text-white focus:outline-none transition-all placeholder-gray-600 shadow-inner"
              />
              <button 
                type="submit"
                disabled={!input.trim() || loading || introLoading}
                className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white rounded-xl flex items-center justify-center transition-all shadow-lg shadow-blue-900/40"
              >
                <Send size={18} />
              </button>
            </form>
